...
#include <qgslabelingengineinter.h>
...
class TestQgsLabelingEngineinter : public QObject
{
    Q_OBJECT
  public:
    TestQgsLabelingEngineinter() = default;
...
void TestQgsLabelingEngineinter::initTestCase()
{
...
void TestQgsLabelingEngineinter::cleanupTestCase()
{
...
void TestQgsLabelingEngineinter::init()
{
...
void TestQgsLabelingEngineinter::cleanup()
{
  QgsProject::instance()->removeMapLayer( vl->id() );
  vl = nullptr;
}

void TestQgsLabelingEngineinter::testEngineSettings()
{
...
void TestQgsLabelingEngineinter::setDefaultLabelParams( QgsPalLayerSettings &settings )
{
...
void TestQgsLabelingEngineinter::testBasic()
{
  QSize size( 640, 480 );
...
void TestQgsLabelingEngineinter::testDiagrams()
{
  QSize size( 640, 480 );
  QgsMapSettings mapSettings;
  mapSettings.setOutputSize( size );
...
void TestQgsLabelingEngineinter::testRuleBased()
{
  QSize size( 640, 480 );
  QgsMapSettings mapSettings;
  mapSettings.setOutputSize( size );
...
void TestQgsLabelingEngineinter::zOrder()
{
  QSize size( 640, 480 );
  QgsMapSettings mapSettings;
  mapSettings.setOutputSize( size );
...
void TestQgsLabelingEngineinter::testEncodeDecodePositionOrder()
{
...
void TestQgsLabelingEngineinter::testSubstitutions()
{
  QgsPalLayerSettings settings;
...
void TestQgsLabelingEngineinter::testCapitalization()
{
  QgsFeature f( vl->fields(), 1 );
  f.setGeometry( QgsGeometry::fromPointXY( QgsPointXY( 1, 2 ) ) );
...
void TestQgsLabelingEngineinter::testParticipatingLayers()
{
  QgsLabelingEngine engine;
...
bool TestQgsLabelingEngineinter::imageCheck( const QString &testName, QImage &image, int mismatchCount )
{
  //draw background
...
void TestQgsLabelingEngineinter::testRegisterFeatureUnprojectible()
{
  QgsPalLayerSettings settings;
  settings.fieldName = QStringLiteral( "'aa label'" );
  settings.isExpression = true;
...
void TestQgsLabelingEngineinter::testRotateHidePartial()
{
  QgsPalLayerSettings settings;
  setDefaultLabelParams( settings );
...
void TestQgsLabelingEngineinter::testParallelLabelSmallFeature()
{
...
void TestQgsLabelingEngineinter::testLabelBoundary()
{
...
void TestQgsLabelingEngineinter::testLabelBlockingRegion()
{
