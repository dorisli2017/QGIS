...
class QgsAlignRaster(sip.wrapper):
    ...
    def rasters(self) -> typing.Any: ...
    def setRasters(self, list: typing.Any) -> None: ...
...
class QgsRelief(sip.wrapper):
    ...
    def reliefColors(self) -> typing.Any: ...
...
class QgsRasterCalcNode(sip.wrapper):
    ...
    def findNodes(self, type: 'QgsRasterCalcNode.Type') -> typing.Any: ...
...
class QgsMeshCalculator(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, formulaString: str, outputFile: str, outputExtent: _core.QgsRectangle, startTime: float, endTime: float, layer: _core.QgsMeshLayer) -> None: ...
    @typing.overload
    def __init__(self, formulaString: str, outputFile: str, outputMask: _core.QgsGeometry, startTime: float, endTime: float, layer: _core.QgsMeshLayer) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QgsMeshCalculator') -> None: ...

    @staticmethod
    def expression_valid(formulaString: str, layer: _core.QgsMeshLayer) -> 'QgsMeshCalculator.Result': ...
    def processCalculation(self, feedback: typing.Optional[_core.QgsFeedback] = ...) -> 'QgsMeshCalculator.Result': ...
...
class QgsGeometrySnapper(QtCore.QObject):
    ...
    def snapFeatures(self, features: typing.Any, snapTolerance: float, mode: 'QgsGeometrySnapper.SnapMode' = ...) -> typing.Any: ...
    @typing.overload
    def snapGeometry(self, geometry: _core.QgsGeometry, snapTolerance: float, mode: 'QgsGeometrySnapper.SnapMode' = ...) -> _core.QgsGeometry: ...
    @typing.overload
    @staticmethod
    def snapGeometry(geometry: _core.QgsGeometry, snapTolerance: float, referenceGeometries: typing.Any, mode: 'QgsGeometrySnapper.SnapMode' = ...) -> _core.QgsGeometry: ...
...
class QgsZonalStatistics(sip.wrapper):
    ...
    def calculateStatistics(self, feedback: _core.QgsFeedback) -> int: ...
...
class QgsInterpolator(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, layerData: typing.Any) -> None: ...
    @typing.overload
...
class QgsGraphBuilder(QgsGraphBuilderInterface):
    ...
    @typing.overload
    def __init__(self, a0: 'QgsGraphBuilder') -> None: ...
...
class QgsGeometryCheckContext(sip.wrapper):
    ...
    def __init__(self, precision: int, mapCrs: _core.QgsCoordinateReferenceSystem, transformContext: _core.QgsCoordinateTransformContext) -> None: ...
...
class QgsGeometryCheck(sip.wrapper):
    ...
    def collectErrors(self, featurePools: typing.Any, errors: typing.Any, messages: typing.Iterable[str], feedback: _core.QgsFeedback, ids: 'QgsGeometryCheck.LayerFeatureIds' = ...) -> typing.Tuple[typing.Any, typing.List[str]]: ...
...
class QgsSingleGeometryCheck(QgsGeometryCheck):
    ...
    def processGeometry(self, geometry: _core.QgsGeometry) -> typing.Any: ...
...
class QgsGeometryCheckRegistry(sip.wrapper):
    ...
    def geometryCheckFactories(self, layer: _core.QgsVectorLayer, type: QgsGeometryCheck.CheckType, flags: typing.Union[QgsGeometryCheck.Flags, QgsGeometryCheck.Flag] = ...) -> typing.Any: ...
