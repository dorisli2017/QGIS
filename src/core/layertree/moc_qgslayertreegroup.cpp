...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsLayerTreeGroup_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 18, 21), // "nodeVisibilityChanged"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 17), // "QgsLayerTreeNode*"
QT_MOC_LITERAL(4, 59, 4) // "node"

    },
    "QgsLayerTreeGroup\0nodeVisibilityChanged\0"
    "\0QgsLayerTreeNode*\0node"
};
...
void QgsLayerTreeGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->nodeVisibilityChanged((*reinterpret_cast< QgsLayerTreeNode*(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject QgsLayerTreeGroup::staticMetaObject = {
    { &QgsLayerTreeNode::staticMetaObject, qt_meta_stringdata_QgsLayerTreeGroup.data,
      qt_meta_data_QgsLayerTreeGroup,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsLayerTreeGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsLayerTreeGroup.stringdata0))
