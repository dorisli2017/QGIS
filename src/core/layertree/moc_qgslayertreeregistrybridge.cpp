...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsLayerTreeRegistryBridge_t, stringdata0) + ofs \
...
void QgsLayerTreeRegistryBridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsLayerTreeRegistryBridge::addedLayersToLayerTree)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QgsLayerTreeRegistryBridge::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsLayerTreeRegistryBridge.data,
      qt_meta_data_QgsLayerTreeRegistryBridge,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsLayerTreeRegistryBridge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsLayerTreeRegistryBridge.stringdata0))
