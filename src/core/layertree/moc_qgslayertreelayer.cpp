...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsLayerTreeLayer_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(4, 51, 16), // "layerNameChanged"
QT_MOC_LITERAL(5, 68, 18) // "layerWillBeDeleted"

    },
    "QgsLayerTreeLayer\0layerLoaded\0\0"
    "layerWillBeUnloaded\0layerNameChanged\0"
    "layerWillBeDeleted"
};
...
void QgsLayerTreeLayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsLayerTreeLayer::layerLoaded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QgsLayerTreeLayer::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsLayerTreeLayer::layerWillBeUnloaded)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QgsLayerTreeLayer::staticMetaObject = {
    { &QgsLayerTreeNode::staticMetaObject, qt_meta_stringdata_QgsLayerTreeLayer.data,
      qt_meta_data_QgsLayerTreeLayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsLayerTreeLayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsLayerTreeLayer.stringdata0))
