...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsNmeaConnection_t, stringdata0) + ofs \
...
const QMetaObject QgsNmeaConnection::staticMetaObject = {
    { &QgsGpsConnection::staticMetaObject, qt_meta_stringdata_QgsNmeaConnection.data,
      qt_meta_data_QgsNmeaConnection,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsNmeaConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsNmeaConnection.stringdata0))
