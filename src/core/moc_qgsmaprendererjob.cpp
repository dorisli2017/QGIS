...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsMapRendererJob_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 18, 23), // "renderingLayersFinished"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 8) // "finished"

    },
    "QgsMapRendererJob\0renderingLayersFinished\0"
    "\0finished"
};
...
void QgsMapRendererJob::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->renderingLayersFinished(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsMapRendererJob::renderingLayersFinished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QgsMapRendererJob::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsMapRendererJob::finished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QgsMapRendererJob::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsMapRendererJob.data,
      qt_meta_data_QgsMapRendererJob,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsMapRendererJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsMapRendererJob.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QgsMapRendererQImageJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QgsMapRendererQImageJob::staticMetaObject = {
    { &QgsMapRendererJob::staticMetaObject, qt_meta_stringdata_QgsMapRendererQImageJob.data,
      qt_meta_data_QgsMapRendererQImageJob,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_QgsMapRendererQImageJob.stringdata0))
        return static_cast<void*>(this);
