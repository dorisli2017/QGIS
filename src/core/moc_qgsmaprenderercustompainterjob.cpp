...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsMapRendererCustomPainterJob_t, stringdata0) + ofs \
...
const QMetaObject QgsMapRendererCustomPainterJob::staticMetaObject = {
    { &QgsMapRendererJob::staticMetaObject, qt_meta_stringdata_QgsMapRendererCustomPainterJob.data,
      qt_meta_data_QgsMapRendererCustomPainterJob,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsMapRendererCustomPainterJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsMapRendererCustomPainterJob.stringdata0))
