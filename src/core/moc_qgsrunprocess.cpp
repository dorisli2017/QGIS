...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsRunProcess_t, stringdata0) + ofs \
...
const QMetaObject QgsRunProcess::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsRunProcess.data,
      qt_meta_data_QgsRunProcess,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsRunProcess::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsRunProcess.stringdata0))
