/****************************************************************************
** Meta object code from reading C++ file 'qgsanimatedicon.h'
**
...
#error "The header file 'qgsanimatedicon.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsAnimatedIcon_t, stringdata0) + ofs \
...
void QgsAnimatedIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsAnimatedIcon::frameChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QgsAnimatedIcon::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsAnimatedIcon.data,
      qt_meta_data_QgsAnimatedIcon,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsAnimatedIcon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsAnimatedIcon.stringdata0))
