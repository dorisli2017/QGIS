...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsGml_t, stringdata0) + ofs \
...
void QgsGml::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsGml::dataReadProgress)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QgsGml::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsGml::totalStepsUpdate)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsGml::dataProgressAndSteps)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QgsGml::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsGml.data,
      qt_meta_data_QgsGml,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsGml::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsGml.stringdata0))
