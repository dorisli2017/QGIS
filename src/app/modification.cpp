...
using namespace lt;
bool debugTrue = true;
Modification::Modification(ModificationSettings& settings){
    size =0;
    enlargePercentage = settings.enlargePercentage;
    shrinkPercentage = settings.shrinkPercentage;
    fixPercentage = settings.fixPercentage;
    global = settings.global;
    enlargeF = settings.enlargeF;
    shrinkF = settings.shrinkF;
}
Modification::Modification(double enlargePercentage,double shrinkPercentage,double fixPercentage,bool global, double enlargeF, double shrinkF){
                    size =0;
                    enlargePercentage = enlargePercentage;
