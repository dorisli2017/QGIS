...
void QgsStatusBarMagnifierWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QgsStatusBarMagnifierWidget *_t = static_cast<QgsStatusBarMagnifierWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QgsStatusBarMagnifierWidget::*_t)(double );
        ...
        {
            typedef void (QgsStatusBarMagnifierWidget::*_t)(bool );
...
const QMetaObject QgsStatusBarMagnifierWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QgsStatusBarMagnifierWidget.data,
      qt_meta_data_QgsStatusBarMagnifierWidget,  qt_static_metacall, nullptr, nullptr}
};
