...
public:
    ...
    void setupUi(QDialog *QgsProcessingDialogBase)
    {
        ...
        mButtonBox->setStandardButtons(QDialogButtonBox::Close|QDialogButtonBox::Help|QDialogButtonBox::Ok);
    ...
    {
        QgsProcessingDialogBase->setWindowTitle(QApplication::translate("QgsProcessingDialogBase", "Dialog", Q_NULLPTR));
