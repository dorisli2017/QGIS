...
public:
    ...
    void setupUi(QDialog *QgsAddTabOrGroupBase)
    {
        ...
        mColumnCountSpinBox = new QSpinBox(QgsAddTabOrGroupBase);
    ...
    {
        QgsAddTabOrGroupBase->setWindowTitle(QApplication::translate("QgsAddTabOrGroupBase", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("QgsAddTabOrGroupBase", "Create category", Q_NULLPTR));
