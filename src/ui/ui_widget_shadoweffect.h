...
public:
    ...
    void setupUi(QWidget *WidgetShadowEffect)
    {
        ...
        mShadowRadiuSpnBx = new QgsSpinBox(mShadowFrame);
        mShadowRadiuSpnBx->setObjectName(QStringLiteral("mShadowRadiuSpnBx"));
        mShadowRadiuSpnBx->setMaximum(16);
        mShadowRadiuSpnBx->setProperty("showClearButton", QVariant(false));

        gridLayout_7->addWidget(mShadowRadiuSpnBx, 2, 1, 1, 2);
    ...
    {
        WidgetShadowEffect->setWindowTitle(QApplication::translate("WidgetShadowEffect", "Form", Q_NULLPTR));
