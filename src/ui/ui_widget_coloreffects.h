...
public:
    ...
    QSpinBox *mColorizeStrengthSpinBox;
    QLabel *label_28;
    QLabel *label_30;
    ...
    void setupUi(QWidget *WidgetColorEffect)
    {
        ...
        mColorizeStrengthSpinBox = new QSpinBox(mShadowFrame);
    ...
    {
        WidgetColorEffect->setWindowTitle(QApplication::translate("WidgetColorEffect", "Form", Q_NULLPTR));
