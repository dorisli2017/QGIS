...
public:
    ...
    void setupUi(QDialog *QgsCptCityColorRampDialogBase)
    {
        ...
        buttonBox = new QDialogButtonBox(QgsCptCityColorRampDialogBase);
        ...
        QWidget::setTabOrder(cboConvertStandard, buttonBox);
        QWidget::setTabOrder(buttonBox, mBrowserView);

        retranslateUi(QgsCptCityColorRampDialogBase);
        QObject::connect(buttonBox, SIGNAL(accepted()), QgsCptCityColorRampDialogBase, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), QgsCptCityColorRampDialogBase, SLOT(reject()));
