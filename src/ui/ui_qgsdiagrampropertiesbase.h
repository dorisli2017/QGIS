...
public:
    ...
    void setupUi(QWidget *QgsDiagramPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 626, 494));
        ...
        gridLayout_7->addWidget(mBackgroundColorDDBtn, 2, 3, 1, 1);
        ...
        gridLayout_7->addWidget(mBackgroundColorButton, 2, 1, 1, 2);

        mPenWidthSpinBox = new QgsDoubleSpinBox(mFormatGrpBox);
        mPenWidthSpinBox->setObjectName(QStringLiteral("mPenWidthSpinBox"));
        sizePolicy3.setHeightForWidth(mPenWidthSpinBox->sizePolicy().hasHeightForWidth());
        mPenWidthSpinBox->setSizePolicy(sizePolicy3);
        mPenWidthSpinBox->setDecimals(5);
        mPenWidthSpinBox->setMaximum(100000);
        mPenWidthSpinBox->setSingleStep(0.2);

        gridLayout_7->addWidget(mPenWidthSpinBox, 4, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mStartAngleDDBtn, 5, 3, 1, 1);

        mAngleOffsetComboBox = new QComboBox(mFormatGrpBox);
        mAngleOffsetComboBox->setObjectName(QStringLiteral("mAngleOffsetComboBox"));
        sizePolicy3.setHeightForWidth(mAngleOffsetComboBox->sizePolicy().hasHeightForWidth());
        mAngleOffsetComboBox->setSizePolicy(sizePolicy3);

        gridLayout_7->addWidget(mAngleOffsetComboBox, 5, 1, 1, 2);
        ...
        horizontalLayout_91 = new QHBoxLayout(mVisiblityGrpBox);
        horizontalLayout_91->setObjectName(QStringLiteral("horizontalLayout_91"));
        horizontalLayout_91->setContentsMargins(6, -1, 6, -1);
        ...
        sizePolicy3.setHeightForWidth(mZIndexSpinBox->sizePolicy().hasHeightForWidth());
        mZIndexSpinBox->setSizePolicy(sizePolicy3);
        ...
        label_8 = new QLabel(mVisiblityGrpBox);
        label_8->setObjectName(QStringLiteral("label_8"));

        horizontalLayout_12->addWidget(label_8);

        mIsObstacleDDBtn = new QgsPropertyOverrideButton(mVisiblityGrpBox);
        ...
        gridLayout_3->addLayout(horizontalLayout_12, 4, 0, 1, 3);
        ...
        horizontalLayout_91->addLayout(gridLayout_3);
        ...
        sizePolicy3.setHeightForWidth(mIncreaseMinimumSizeSpinBox->sizePolicy().hasHeightForWidth());
        mIncreaseMinimumSizeSpinBox->setSizePolicy(sizePolicy3);
        ...
        gridLayout_12->addWidget(mLinePlacementFrame, 3, 0, 1, 2);
        ...
        gridLayout_12->addWidget(mPriorityGrpBox, 7, 0, 1, 2);
        ...
        sizePolicy3.setHeightForWidth(mDiagramDistanceSpinBox->sizePolicy().hasHeightForWidth());
        mDiagramDistanceSpinBox->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(stackedPlacement->sizePolicy().hasHeightForWidth());
        stackedPlacement->setSizePolicy(sizePolicy3);
        ...
        QWidget::setTabOrder(mStartAngleDDBtn, mDiagramFontButton);
        QWidget::setTabOrder(mDiagramFontButton, mZIndexSpinBox);
        ...
        QWidget::setTabOrder(mScaleVisibilityGroupBox, mShowDiagramDDBtn);
        QWidget::setTabOrder(mShowDiagramDDBtn, mAlwaysShowDDBtn);
        QWidget::setTabOrder(mAlwaysShowDDBtn, mIsObstacleDDBtn);
        QWidget::setTabOrder(mIsObstacleDDBtn, scrollArea_5);
        ...
        QWidget::setTabOrder(mPriorityDDBtn, scrollArea_7);
