...
public:
    ...
    QGroupBox *groupEdges;
    QGridLayout *gridLayout;
    QLabel *label_6;
    QDoubleSpinBox *spinEdgeWidth;
    QLabel *label_7;
    ...
    void setupUi(QWidget *Polygon3DSymbolWidget)
    {
        ...
        Polygon3DSymbolWidget->resize(561, 697);
        ...
        gridLayout_2->addWidget(chkAddBackFaces, 5, 0, 1, 1);
        ...
        groupEdges = new QGroupBox(Polygon3DSymbolWidget);
        ...
        spinEdgeWidth = new QDoubleSpinBox(groupEdges);
        ...
        line = new QFrame(Polygon3DSymbolWidget);
        line->setObjectName(QStringLiteral("line"));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);

        gridLayout_2->addWidget(line, 7, 0, 1, 3);
        ...
        widgetMaterial = new QgsPhongMaterialWidget(Polygon3DSymbolWidget);
        widgetMaterial->setObjectName(QStringLiteral("widgetMaterial"));

        gridLayout_2->addWidget(widgetMaterial, 8, 0, 1, 3);
        ...
        gridLayout_2->addWidget(chkInvertNormals, 6, 0, 1, 2);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_2->addItem(verticalSpacer, 10, 0, 1, 3);
    ...
    {
        Polygon3DSymbolWidget->setWindowTitle(QApplication::translate("Polygon3DSymbolWidget", "Form", Q_NULLPTR));
