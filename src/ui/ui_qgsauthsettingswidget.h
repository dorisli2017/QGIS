...
public:
    ...
    {
        QgsAuthSettingsWidget->setWindowTitle(QApplication::translate("QgsAuthSettingsWidget", "Form", Q_NULLPTR));
        ...
        lblWarning->setText(QApplication::translate("QgsAuthSettingsWidget", "Warning text!", Q_NULLPTR));
