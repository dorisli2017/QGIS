...
public:
    ...
    QDoubleSpinBox *mRefreshLayerIntervalSpinBox;
    ...
    QLabel *label1;
    QgsLayerTreeView *mLayersDependenciesTreeView;
    QLabel *label_4;
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        QgsVectorLayerPropertiesBase->resize(825, 856);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/images/themes/default/propertyicons/diagram.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem4 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem4->setIcon(icon5);
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/images/themes/default/3d.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon14;
        icon14.addFile(QStringLiteral(":/images/themes/default/mIconExpression.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem13 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem13->setIcon(icon14);
        QIcon icon15;
        icon15.addFile(QStringLiteral(":/images/themes/default/propertyicons/editmetadata.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem14 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem14->setIcon(icon15);
        QIcon icon16;
        icon16.addFile(QStringLiteral(":/images/themes/default/dependencies.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem15 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem15->setIcon(icon16);
        QIcon icon17;
        icon17.addFile(QStringLiteral(":/images/themes/default/legend.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem16 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem16->setIcon(icon17);
        QIcon icon18;
        icon18.addFile(QStringLiteral(":/images/themes/default/propertyicons/overlay.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem17 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem17->setIcon(icon18);
        QIcon icon19;
        icon19.addFile(QStringLiteral(":/images/themes/default/propertyicons/digitizing.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 662, 804));
...
"border-radius: 2px;"));
        ...
        mGeometryGroupBox = new QgsCollapsibleGroupBox(scrollAreaWidgetContents_4);
        mGeometryGroupBox->setObjectName(QStringLiteral("mGeometryGroupBox"));
        mGeometryGroupBox->setFocusPolicy(Qt::StrongFocus);
        mGeometryGroupBox->setCheckable(false);
        mGeometryGroupBox->setProperty("syncGroup", QVariant(QStringLiteral("vectorgeneral")));
        verticalLayout_28 = new QVBoxLayout(mGeometryGroupBox);
        verticalLayout_28->setSpacing(6);
        verticalLayout_28->setObjectName(QStringLiteral("verticalLayout_28"));
        label_5 = new QLabel(mGeometryGroupBox);
        label_5->setObjectName(QStringLiteral("label_5"));

        verticalLayout_28->addWidget(label_5);

        mCrsSelector = new QgsProjectionSelectionWidget(mGeometryGroupBox);
        ...
        pbnIndex = new QPushButton(mGeometryGroupBox);
        pbnIndex->setObjectName(QStringLiteral("pbnIndex"));

        horizontalLayout_10->addWidget(pbnIndex);

        pbnUpdateExtents = new QPushButton(mGeometryGroupBox);
        pbnUpdateExtents->setObjectName(QStringLiteral("pbnUpdateExtents"));

        horizontalLayout_10->addWidget(pbnUpdateExtents);
        ...
        line_2 = new QFrame(mGeometryGroupBox);
        ...
        verticalLayout_9->addWidget(mGeometryGroupBox);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 662, 804));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 662, 804));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 662, 804));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 734, 790));
        ...
        mRefreshLayerIntervalSpinBox = new QDoubleSpinBox(scrollAreaWidgetContents_19);
        ...
        mLayersDependenciesTreeView = new QgsLayerTreeView(groupBox_5);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 662, 804));
        ...
        mOptsPage_Digitizing = new QWidget();
        mOptsPage_Digitizing->setObjectName(QStringLiteral("mOptsPage_Digitizing"));
        gridLayout_12 = new QGridLayout(mOptsPage_Digitizing);
        gridLayout_12->setObjectName(QStringLiteral("gridLayout_12"));
        gridLayout_12->setContentsMargins(0, 0, 0, 0);
        scrollArea_2 = new QScrollArea(mOptsPage_Digitizing);
        scrollArea_2->setObjectName(QStringLiteral("scrollArea_2"));
        scrollArea_2->setWidgetResizable(true);
        scrollAreaWidgetContents_2 = new QWidget();
        scrollAreaWidgetContents_2->setObjectName(QStringLiteral("scrollAreaWidgetContents_2"));
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 658, 800));
        ...
        gridLayout_12->addWidget(scrollArea_2, 0, 0, 1, 1);

        mOptionsStackedWidget->addWidget(mOptsPage_Digitizing);
        ...
        QWidget::setTabOrder(cboProviderEncoding, mGeometryGroupBox);
        QWidget::setTabOrder(mGeometryGroupBox, mCrsSelector);
        ...
        QWidget::setTabOrder(mLayerLegendUrlFormatComboBox, mRemoveDuplicateNodesCheckbox);
    ...
    void retranslateUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        ___qlistwidgetitem->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Information", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem2->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Symbology", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem3->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Labels", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem4 = mOptionsListWidget->item(4);
        ___qlistwidgetitem4->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Diagrams", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem4->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Diagrams", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem5 = mOptionsListWidget->item(5);
        ___qlistwidgetitem5->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "3D View", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem5->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "3D View", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem6 = mOptionsListWidget->item(6);
        ___qlistwidgetitem6->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Source Fields", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem6->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Source Fields", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem7->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Form", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem8->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Joins", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem10->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Actions", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        ___qlistwidgetitem13->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Variables", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem13->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Variables", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem14 = mOptionsListWidget->item(14);
        ___qlistwidgetitem14->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Metadata", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem15 = mOptionsListWidget->item(15);
        ___qlistwidgetitem15->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Dependencies", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem15->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Dependencies", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem16 = mOptionsListWidget->item(16);
        ___qlistwidgetitem16->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Legend", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem16->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Legend", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem17 = mOptionsListWidget->item(17);
        ___qlistwidgetitem17->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "QGIS Server", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem17->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Edit QGIS Server settings", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem18 = mOptionsListWidget->item(18);
        ___qlistwidgetitem18->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Digitizing", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem18->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "Control geometry and topology constraints for digitizing operations.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mOptionsListWidget->setSortingEnabled(__sortingEnabled);

#ifndef QT_NO_TOOLTIP
        mOptionsListWidget->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "<html><head/><body><p>If the remove duplicate nodes option is activated, duplicate vertices will automatically be removed from geometries which are edited on this layer.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        mGeometryGroupBox->setTitle(QApplication::translate("QgsVectorLayerPropertiesBase", "Geometry and Coordinate Reference System", Q_NULLPTR));
        label_5->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Set source coordinate reference system", Q_NULLPTR));
        ...
        mGeometryAutoFixesGroupBox->setTitle(QApplication::translate("QgsVectorLayerPropertiesBase", "Automatic Fixes", Q_NULLPTR));
        mRemoveDuplicateNodesCheckbox->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Remove duplicate nodes", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "<html><head/><body><p>The geometry precision defines the maximum precision to of geometry coordinates that should be stored on this layer. A snap to grid algorithm will be applied on every geometry entering this layer, resulting in coordinates being rounded to multiples of this value. The operation is applied in this layer's coordinate reference system.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Geometry precision", Q_NULLPTR));
        mPrecisionUnitsLabel->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "[Units]", Q_NULLPTR));
        mGeometryPrecisionLineEdit->setText(QString());
        mGeometryPrecisionLineEdit->setPlaceholderText(QApplication::translate("QgsVectorLayerPropertiesBase", "[No precision restriction]", Q_NULLPTR));
        mGeometryValidationGroupBox->setTitle(QApplication::translate("QgsVectorLayerPropertiesBase", "Geometry checks", Q_NULLPTR));
        mTopologyChecksGroupBox->setTitle(QApplication::translate("QgsVectorLayerPropertiesBase", "Topology checks", Q_NULLPTR));
    } // retranslateUi
