...
public:
    ...
    void setupUi(QgsPanelWidget *QgsLimitedRandomColorRampWidgetBase)
    {
        ...
        spinHue1 = new QSpinBox(QgsLimitedRandomColorRampWidgetBase);
        ...
        spinHue2 = new QSpinBox(QgsLimitedRandomColorRampWidgetBase);
        ...
        spinSat1 = new QSpinBox(QgsLimitedRandomColorRampWidgetBase);
        ...
        spinSat2 = new QSpinBox(QgsLimitedRandomColorRampWidgetBase);
        ...
        spinVal1 = new QSpinBox(QgsLimitedRandomColorRampWidgetBase);
        ...
        spinVal2 = new QSpinBox(QgsLimitedRandomColorRampWidgetBase);
        ...
        spinCount = new QSpinBox(QgsLimitedRandomColorRampWidgetBase);
