...
public:
    ...
    void setupUi(QWidget *QgsAttributesFormProperties)
    {
        ...
        QgsAttributesFormProperties->resize(1041, 556);
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 598, 490));
    ...
    {
        QgsAttributesFormProperties->setWindowTitle(QApplication::translate("QgsAttributesFormProperties", "Form", Q_NULLPTR));
        mEditorLayoutComboBox->clear();
        mEditorLayoutComboBox->insertItems(0, QStringList()
         << QApplication::translate("QgsAttributesFormProperties", "Autogenerate", Q_NULLPTR)
         << QApplication::translate("QgsAttributesFormProperties", "Drag and drop designer", Q_NULLPTR)
         << QApplication::translate("QgsAttributesFormProperties", "Provide ui-file", Q_NULLPTR)
        );
