...
public:
    ...
    void setupUi(QDialog *QgsNewHttpConnectionBase)
    {
        ...
        QgsNewHttpConnectionBase->resize(448, 828);
        ...
        gridLayout_2->addWidget(cbxWmsIgnoreAxisOrientation, 4, 0, 1, 2);
        ...
        gridLayout1->addWidget(cbxWfsIgnoreAxisOrientation, 4, 0, 1, 2);
        ...
        gridLayout1->addWidget(txtMaxNumFeatures, 1, 1, 1, 1);

        layoutWfsVersion = new QHBoxLayout();
        layoutWfsVersion->setSpacing(6);
        layoutWfsVersion->setObjectName(QStringLiteral("layoutWfsVersion"));
        cmbVersion = new QComboBox(mWfsOptionsGroupBox);
        cmbVersion->setObjectName(QStringLiteral("cmbVersion"));

        layoutWfsVersion->addWidget(cmbVersion);
        ...
        layoutWfsVersion->addWidget(mWfsVersionDetectButton);


        gridLayout1->addLayout(layoutWfsVersion, 0, 1, 1, 1);
        ...
        QWidget::setTabOrder(cbxWfsInvertAxisOrientation, txtReferer);
        QWidget::setTabOrder(txtReferer, cmbDpiMode);
    ...
    void retranslateUi(QDialog *QgsNewHttpConnectionBase)
    {
        ...
        lblReferer->setText(QApplication::translate("QgsNewHttpConnectionBase", "&Referer", Q_NULLPTR));
