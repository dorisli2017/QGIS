...
public:
    ...
    void setupUi(QWidget *WidgetGlow)
    {
        ...
        mBlurRadiusSpnBx = new QgsSpinBox(mShadowFrame);
        mBlurRadiusSpnBx->setObjectName(QStringLiteral("mBlurRadiusSpnBx"));
        mBlurRadiusSpnBx->setMaximum(16);
        mBlurRadiusSpnBx->setProperty("showClearButton", QVariant(false));

        gridLayout_7->addWidget(mBlurRadiusSpnBx, 1, 1, 1, 2);
    ...
    {
        WidgetGlow->setWindowTitle(QApplication::translate("WidgetGlow", "Form", Q_NULLPTR));
