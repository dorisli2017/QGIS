...
public:
    ...
    void setupUi(QWidget *WidgetRasterMarker)
    {
        ...
        gridLayout_2->addWidget(mAnchorPointLabel, 10, 0, 2, 1);
        ...
        gridLayout_3->addWidget(mSizeUnitWidget, 0, 3, 2, 1);
        ...
        gridLayout_2->addWidget(mHorizontalAnchorComboBox, 11, 1, 1, 1);
        ...
        gridLayout_2->addWidget(mVerticalAnchorDDBtn, 10, 2, 1, 1);
        ...
        gridLayout_2->addWidget(mHorizontalAnchorDDBtn, 11, 2, 1, 1);
        ...
        gridLayout_2->addWidget(mVerticalAnchorComboBox, 10, 1, 1, 1);
        ...
        QWidget::setTabOrder(mWidthSpinBox, mSizeUnitWidget);
        ...
        QWidget::setTabOrder(mHeightDDBtn, mOpacityWidget);
        ...
        QWidget::setTabOrder(mSpinOffsetX, mOffsetUnitWidget);
        QWidget::setTabOrder(mOffsetUnitWidget, mOffsetDDBtn);
        QWidget::setTabOrder(mOffsetDDBtn, mSpinOffsetY);
        QWidget::setTabOrder(mSpinOffsetY, mVerticalAnchorComboBox);
    ...
    {
        WidgetRasterMarker->setWindowTitle(QApplication::translate("WidgetRasterMarker", "Form", Q_NULLPTR));
