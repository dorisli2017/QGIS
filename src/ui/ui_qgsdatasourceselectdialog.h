...
public:
    ...
    void setupUi(QDialog *QgsDataSourceSelectDialog)
    {
        ...
        mContents = new QWidget(QgsDataSourceSelectDialog);
        mContents->setObjectName(QStringLiteral("mContents"));
        verticalLayout_2 = new QVBoxLayout(mContents);
        ...
        mBrowserTreeView = new QgsBrowserTreeView(mContents);
        ...
        buttonBox = new QDialogButtonBox(QgsDataSourceSelectDialog);
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), QgsDataSourceSelectDialog, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), QgsDataSourceSelectDialog, SLOT(reject()));

        QMetaObject::connectSlotsByName(QgsDataSourceSelectDialog);
    } // setupUi

    void retranslateUi(QDialog *QgsDataSourceSelectDialog)
    {
        QgsDataSourceSelectDialog->setWindowTitle(QApplication::translate("QgsDataSourceSelectDialog", "Dialog", Q_NULLPTR));
