...
public:
    ...
    void setupUi(QWidget *QgsRasterTransparencyWidget)
    {
        ...
        sizePolicy1.setHeightForWidth(gboxCustomTransparency->sizePolicy().hasHeightForWidth());
        gboxCustomTransparency->setSizePolicy(sizePolicy1);
        ...
        sizePolicy2.setHeightForWidth(lblTransparent->sizePolicy().hasHeightForWidth());
        lblTransparent->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(cboxTransparencyBand->sizePolicy().hasHeightForWidth());
        cboxTransparencyBand->setSizePolicy(sizePolicy3);
    ...
    {
        QgsRasterTransparencyWidget->setWindowTitle(QApplication::translate("QgsRasterTransparencyWidget", "Form", Q_NULLPTR));
