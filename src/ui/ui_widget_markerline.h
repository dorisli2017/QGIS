...
public:
    ...
    void setupUi(QWidget *WidgetMarkerLine)
    {
        ...
        gridLayout_3->addWidget(radCurvePoint, 8, 1, 1, 1);
        ...
        QWidget::setTabOrder(radCentralPoint, radCurvePoint);
    ...
    {
        WidgetMarkerLine->setWindowTitle(QApplication::translate("WidgetMarkerLine", "Form", Q_NULLPTR));
        ...
        chkRotateMarker->setText(QApplication::translate("WidgetMarkerLine", "Rotate marker", Q_NULLPTR));
