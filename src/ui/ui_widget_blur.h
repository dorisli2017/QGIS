...
public:
    ...
    void setupUi(QWidget *WidgetBlur)
    {
        ...
        gridLayout_7->addWidget(mBlurTypeCombo, 0, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mBlendCmbBx, 3, 1, 1, 1);

        mBlurStrengthSpnBx = new QgsSpinBox(mShadowFrame);
        ...
        gridLayout_7->addWidget(mDrawModeComboBox, 4, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mOpacityWidget, 2, 1, 1, 1);
    ...
    {
        WidgetBlur->setWindowTitle(QApplication::translate("WidgetBlur", "Form", Q_NULLPTR));
