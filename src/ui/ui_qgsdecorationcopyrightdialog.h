...
public:
    ...
    void setupUi(QDialog *QgsDecorationCopyrightDialog)
    {
        ...
        mButtonFontStyle->setEnabled(true);
    ...
    void retranslateUi(QDialog *QgsDecorationCopyrightDialog)
    {
        ...
        mInsertExpressionButton->setText(QApplication::translate("QgsDecorationCopyrightDialog", "Insert an Expression\342\200\246", Q_NULLPTR));
