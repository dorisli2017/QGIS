...
public:
    ...
    {
        LayerPropertiesWidget->setWindowTitle(QApplication::translate("LayerPropertiesWidget", "Form", Q_NULLPTR));
        ...
        mEnabledCheckBox->setText(QApplication::translate("LayerPropertiesWidget", "Enable layer", Q_NULLPTR));
