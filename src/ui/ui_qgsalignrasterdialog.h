...
public:
    ...
    QDoubleSpinBox *mSpinCellSizeX;
    QDoubleSpinBox *mSpinCellSizeY;
    QHBoxLayout *horizontalLayout_4;
    QDoubleSpinBox *mSpinGridOffsetX;
    QDoubleSpinBox *mSpinGridOffsetY;
    ...
    void setupUi(QDialog *QgsAlignRasterDialog)
    {
        ...
        mSpinCellSizeX = new QDoubleSpinBox(QgsAlignRasterDialog);
        ...
        mSpinCellSizeY = new QDoubleSpinBox(QgsAlignRasterDialog);
        ...
        mSpinGridOffsetX = new QDoubleSpinBox(QgsAlignRasterDialog);
        ...
        mSpinGridOffsetY = new QDoubleSpinBox(QgsAlignRasterDialog);
