...
public:
    ...
    void setupUi(QDialog *QgsIdentifyResultsBase)
    {
        ...
        cbxAutoFeatureForm->setObjectName(QStringLiteral("cbxAutoFeatureForm"));
    ...
    void retranslateUi(QDialog *QgsIdentifyResultsBase)
    {
...
#ifndef QT_NO_TOOLTIP
        mActionCopy->setToolTip(QApplication::translate("QgsIdentifyResultsBase", "Copy Selected Feature to Clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        cbxAutoFeatureForm->setText(QApplication::translate("QgsIdentifyResultsBase", "Auto open form", Q_NULLPTR));
