...
public:
    ...
    void setupUi(QDialog *QgsCustomProjectionDialogBase)
    {
        ...
        horizontalLayout_2->addWidget(teParameters);

        pbnCopyCRS = new QPushButton(groupBox);
        pbnCopyCRS->setObjectName(QStringLiteral("pbnCopyCRS"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/images/themes/default/mActionEditCopy.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pbnCopyCRS->setIcon(icon3);

        horizontalLayout_2->addWidget(pbnCopyCRS);
        ...
        QWidget::setTabOrder(pbnCopyCRS, northWGS84);
    ...
    void retranslateUi(QDialog *QgsCustomProjectionDialogBase)
    {
        ...
        label->setText(QApplication::translate("QgsCustomProjectionDialogBase", "You can define your own custom Coordinate Reference System (CRS) here. The definition must conform to the proj4 format for specifying a CRS.", Q_NULLPTR));
