...
public:
    ...
    void setupUi(QDialog *QgsJoinDialogBase)
    {
        ...
        QgsJoinDialogBase->resize(505, 487);
        ...
        gridLayout->addWidget(mDynamicFormCheckBox, 6, 0, 1, 1);
        ...
        gridLayout->addWidget(mEditableJoinLayer, 7, 0, 1, 1);
    ...
    void retranslateUi(QDialog *QgsJoinDialogBase)
    {
        ...
        mCacheInMemoryCheckBox->setText(QApplication::translate("QgsJoinDialogBase", "Cache join layer in virtual memory", Q_NULLPTR));
