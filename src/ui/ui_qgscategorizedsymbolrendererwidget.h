...
public:
    ...
    void setupUi(QWidget *QgsCategorizedSymbolRendererWidget)
    {
        ...
        btnChangeCategorizedSymbol = new QPushButton(QgsCategorizedSymbolRendererWidget);
    ...
    {
        label_3->setText(QApplication::translate("QgsCategorizedSymbolRendererWidget", "Column", Q_NULLPTR));
