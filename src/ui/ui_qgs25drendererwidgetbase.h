...
public:
    ...
    QDoubleSpinBox *mShadowSizeWidget;
    QLabel *label_6;
    ...
    void setupUi(QWidget *Qgs25DRendererWidgetBase)
    {
        ...
        mShadowSizeWidget = new QDoubleSpinBox(mShadowEnabledWidget);
    ...
    {
        Qgs25DRendererWidgetBase->setWindowTitle(QApplication::translate("Qgs25DRendererWidgetBase", "Form", Q_NULLPTR));
