...
public:
    ...
    void setupUi(QDialog *QgsProcessingMatrixParameterDialogBase)
    {
        ...
        QObject::connect(mButtonBox, SIGNAL(accepted()), QgsProcessingMatrixParameterDialogBase, SLOT(accept()));
        QObject::connect(mButtonBox, SIGNAL(rejected()), QgsProcessingMatrixParameterDialogBase, SLOT(reject()));

        QMetaObject::connectSlotsByName(QgsProcessingMatrixParameterDialogBase);
    } // setupUi

    void retranslateUi(QDialog *QgsProcessingMatrixParameterDialogBase)
    {
