...
public:
    ...
    void setupUi(QDialog *QgsGradientColorRampDialogBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 850, 492));
        ...
        buttonBox = new QDialogButtonBox(QgsGradientColorRampDialogBase);
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), QgsGradientColorRampDialogBase, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), QgsGradientColorRampDialogBase, SLOT(reject()));
