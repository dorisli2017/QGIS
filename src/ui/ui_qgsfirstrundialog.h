...
public:
    ...
    void setupUi(QDialog *QgsFirstRunDialog)
    {
        ...
        label = new QLabel(QgsFirstRunDialog);
        label->setObjectName(QStringLiteral("label"));

        verticalLayout->addWidget(label);

        mImportSettingsYes = new QRadioButton(QgsFirstRunDialog);
        mImportSettingsYes->setObjectName(QStringLiteral("mImportSettingsYes"));
        mImportSettingsYes->setChecked(true);

        verticalLayout->addWidget(mImportSettingsYes);

        mImportSettingsNo = new QRadioButton(QgsFirstRunDialog);
        mImportSettingsNo->setObjectName(QStringLiteral("mImportSettingsNo"));

        verticalLayout->addWidget(mImportSettingsNo);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout->addItem(verticalSpacer);

        label_4 = new QLabel(QgsFirstRunDialog);
