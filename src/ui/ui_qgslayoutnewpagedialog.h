...
public:
    ...
    QSpinBox *mPagesSpinBox;
    QLabel *label_2;
    QSpacerItem *horizontalSpacer;
    QLabel *label;
    QComboBox *mPositionComboBox;
    QSpinBox *mExistingPageSpinBox;
    ...
    void setupUi(QDialog *QgsLayoutNewPageDialog)
    {
        ...
        mPagesSpinBox = new QSpinBox(QgsLayoutNewPageDialog);
        ...
        mExistingPageSpinBox = new QSpinBox(QgsLayoutNewPageDialog);
