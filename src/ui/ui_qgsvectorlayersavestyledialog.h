...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerSaveStyleDialog)
    {
        ...
        gridLayout_2->addWidget(mStyleCategoriesListView, 1, 1, 1, 1);


        gridLayout->addWidget(mSaveToFileWidget, 1, 0, 1, 2);
        ...
        gridLayout->addWidget(mSaveToDbWidget, 2, 0, 1, 2);

#ifndef QT_NO_SHORTCUT
        nameLabel->setBuddy(mDbStyleNameEdit);
        mUILabel->setBuddy(mDbStyleNameEdit);
#endif // QT_NO_SHORTCUT
        QWidget::setTabOrder(mStyleTypeComboBox, mStyleCategoriesListView);
