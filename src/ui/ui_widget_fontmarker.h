...
public:
    ...
    void setupUi(QWidget *WidgetFontMarker)
    {
        ...
        gridLayout_3->addWidget(btnColor, 2, 2, 1, 1);
        ...
        gridLayout_3->addWidget(btnStrokeColor, 3, 2, 1, 1);
        ...
        gridLayout_3->addWidget(mStrokeWidthDDBtn, 4, 3, 1, 1);
        ...
        gridLayout_3->addLayout(gridLayout_2, 9, 2, 1, 1);
        ...
        gridLayout_3->addWidget(mAnchorPointLabel, 10, 0, 3, 1);
        ...
        gridLayout_3->addWidget(mStrokeColorDDBtn, 3, 3, 1, 1);
        ...
        gridLayout_3->addWidget(mHorizontalAnchorComboBox, 11, 2, 1, 1);
        ...
        gridLayout_3->addWidget(spinAngle, 8, 2, 1, 1);
        ...
        gridLayout_3->addLayout(gridLayout, 13, 0, 1, 3);
        ...
        gridLayout_3->addLayout(horizontalLayout, 1, 2, 1, 1);

        mSizeDDBtn = new QgsPropertyOverrideButton(WidgetFontMarker);
        mSizeDDBtn->setObjectName(QStringLiteral("mSizeDDBtn"));

        gridLayout_3->addWidget(mSizeDDBtn, 1, 3, 1, 1);

        QWidget::setTabOrder(cboFont, spinSize);
    ...
    {
        WidgetFontMarker->setWindowTitle(QApplication::translate("WidgetFontMarker", "Form", Q_NULLPTR));
        ...
        label->setText(QApplication::translate("WidgetFontMarker", "Font family", Q_NULLPTR));
