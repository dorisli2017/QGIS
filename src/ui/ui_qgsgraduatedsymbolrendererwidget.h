...
public:
    ...
    QgsDoubleSpinBox *spinSymmetryPointForOtherMethods;
    QLabel *label_2;
    QComboBox *cboSymmetryPointForPretty;
    ...
    void setupUi(QWidget *QgsGraduatedSymbolRendererWidget)
    {
        ...
        QgsGraduatedSymbolRendererWidget->resize(482, 618);
        ...
        btnChangeGraduatedSymbol = new QPushButton(QgsGraduatedSymbolRendererWidget);
        ...
        spinPrecision = new QSpinBox(QgsGraduatedSymbolRendererWidget);
        ...
        label_3 = new QLabel(QgsGraduatedSymbolRendererWidget);
        ...
        sizePolicy3.setHeightForWidth(btnColorRamp->sizePolicy().hasHeightForWidth());
        btnColorRamp->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(lblSizeTo->sizePolicy().hasHeightForWidth());
        lblSizeTo->setSizePolicy(sizePolicy4);
        ...
        spinGraduatedClasses = new QSpinBox(tab);
        spinGraduatedClasses->setObjectName(QStringLiteral("spinGraduatedClasses"));
        sizePolicy2.setHeightForWidth(spinGraduatedClasses->sizePolicy().hasHeightForWidth());
        spinGraduatedClasses->setSizePolicy(sizePolicy2);
        ...
        spinSymmetryPointForOtherMethods = new QgsDoubleSpinBox(mGroupBoxSymmetric);
        spinSymmetryPointForOtherMethods->setObjectName(QStringLiteral("spinSymmetryPointForOtherMethods"));
        spinSymmetryPointForOtherMethods->setMinimum(-1e+74);
        spinSymmetryPointForOtherMethods->setMaximum(1e+74);
        spinSymmetryPointForOtherMethods->setValue(100);
        spinSymmetryPointForOtherMethods->setProperty("showClearButton", QVariant(false));

        gridLayout_2->addWidget(spinSymmetryPointForOtherMethods, 0, 1, 1, 1);
        ...
        cboSymmetryPointForPretty = new QComboBox(mGroupBoxSymmetric);
        cboSymmetryPointForPretty->setObjectName(QStringLiteral("cboSymmetryPointForPretty"));

        gridLayout_2->addWidget(cboSymmetryPointForPretty, 1, 0, 1, 2);
        ...
        verticalLayout->addWidget(mGroupBoxSymmetric);
    ...
    {
        label_4->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Column", Q_NULLPTR));
...
"Negative rounds to powers of 10", Q_NULLPTR));
        ...
        label_3->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Method", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ...
        spinSymmetryPointForOtherMethods->setSpecialValueText(QString());
