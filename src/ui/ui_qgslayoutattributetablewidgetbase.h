...
public:
    ...
    QgsColorButton *mHeaderFontColorButton;
    ...
    QgsColorButton *mContentFontColorButton;
    ...
    void setupUi(QWidget *QgsLayoutAttributeTableWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 394, 1487));
        ...
        gridLayout_6->addWidget(mWrapBehaviorComboBox, 10, 1, 1, 1);
        ...
        mHeaderFontColorButton = new QgsColorButton(groupBox_2);
        mHeaderFontColorButton->setObjectName(QStringLiteral("mHeaderFontColorButton"));
        ...
        mContentFontColorButton = new QgsColorButton(groupBox_4);
        mContentFontColorButton->setObjectName(QStringLiteral("mContentFontColorButton"));
        ...
        QWidget::setTabOrder(mHeaderFontToolButton, mHeaderFontColorButton);
        ...
        QWidget::setTabOrder(mContentFontToolButton, mContentFontColorButton);
    ...
    void retranslateUi(QWidget *QgsLayoutAttributeTableWidgetBase)
    {
        ...
        mHeaderModeComboBox->insertItems(0, QStringList()
         << QApplication::translate("QgsLayoutAttributeTableWidgetBase", "On first frame", Q_NULLPTR)
         << QApplication::translate("QgsLayoutAttributeTableWidgetBase", "On all frames", Q_NULLPTR)
         << QApplication::translate("QgsLayoutAttributeTableWidgetBase", "No header", Q_NULLPTR)
        );
        ...
        mHeaderHAlignmentComboBox->insertItems(0, QStringList()
         << QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Follow column alignment", Q_NULLPTR)
         << QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Left", Q_NULLPTR)
         << QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Center", Q_NULLPTR)
         << QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Right", Q_NULLPTR)
        );
        label_3->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Color", Q_NULLPTR));
        ...
        label_4->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Color", Q_NULLPTR));
