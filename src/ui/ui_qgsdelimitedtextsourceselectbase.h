...
public:
    ...
    QgsCollapsibleGroupBox *layeSettingsGroupBox;
    ...
    void setupUi(QDialog *QgsDelimitedTextSourceSelectBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 714, 514));
        ...
        fileFormatGroupBox->setCollapsed(false);
        ...
        gridLayout_71->setContentsMargins(-1, 0, 0, -1);
        ...
        gridLayout_71->addWidget(delimiterChars, 3, 0, 1, 1);
        ...
        gridLayout_71->addWidget(delimiterCSV, 0, 0, 1, 1);
        ...
        gridLayout_71->addWidget(delimiterRegexp, 2, 0, 1, 1);


        gridLayout_3->addLayout(gridLayout_71, 0, 0, 1, 1);
        ...
        layoutDelimChars->addWidget(cbxDelimSemicolon, 3, 0, 1, 1);
        ...
        layoutDelimChars->addLayout(horizontalLayout_3, 3, 6, 1, 1);
        ...
        layoutDelimChars->addWidget(cbxDelimSpace, 0, 6, 1, 1);
        ...
        recordOptionsGroupBox->setCollapsed(true);
        ...
        rowCounter = new QSpinBox(recordOptionsGroupBox);
        ...
        geometryDefinitionGroupBox->setCollapsed(true);
        ...
        gridLayout_5->addWidget(cbxXyDms, 4, 1, 1, 1);
        ...
        gridLayout_5->addWidget(cmbXField, 1, 1, 1, 1);
        ...
        gridLayout_5->addWidget(cmbYField, 2, 1, 1, 1);
        ...
        gridLayout_5->addWidget(textLabelx, 1, 0, 1, 1);
        ...
        gridLayout_5->addWidget(textLabely, 2, 0, 1, 1);
        ...
        gridLayout_2->addWidget(cmbGeometryType, 1, 2, 1, 1);
        ...
        gridLayout_2->addWidget(cmbWktField, 0, 2, 1, 1);
        ...
        gridLayout->addWidget(crsGeometry, 1, 1, 1, 1);


        verticalLayout_4->addWidget(geometryDefinitionGroupBox);

        layeSettingsGroupBox = new QgsCollapsibleGroupBox(scrollAreaWidgetContents);
        layeSettingsGroupBox->setObjectName(QStringLiteral("layeSettingsGroupBox"));
        sizePolicy1.setHeightForWidth(layeSettingsGroupBox->sizePolicy().hasHeightForWidth());
        layeSettingsGroupBox->setSizePolicy(sizePolicy1);
        layeSettingsGroupBox->setCollapsed(true);
        verticalLayout_14 = new QVBoxLayout(layeSettingsGroupBox);
        ...
        verticalLayout_4->addWidget(layeSettingsGroupBox);
        ...
        sizePolicy10.setHeightForWidth(sampleDataGroupBox->sizePolicy().hasHeightForWidth());
        sampleDataGroupBox->setSizePolicy(sizePolicy10);
        ...
        sizePolicy11.setHeightForWidth(tblSample->sizePolicy().hasHeightForWidth());
        tblSample->setSizePolicy(sizePolicy11);
        ...
        QWidget::setTabOrder(txtEscapeChars, recordOptionsGroupBox);
        ...
        QWidget::setTabOrder(cbxXyDms, crsGeometry);
        QWidget::setTabOrder(crsGeometry, layeSettingsGroupBox);
        QWidget::setTabOrder(layeSettingsGroupBox, cbxSpatialIndex);
        ...
        QWidget::setTabOrder(tblSample, cmbWktField);
        QWidget::setTabOrder(cmbWktField, cmbGeometryType);
        QWidget::setTabOrder(cmbGeometryType, txtDelimiterRegexp);
    ...
    void retranslateUi(QDialog *QgsDelimitedTextSourceSelectBase)
    {
...
#endif // QT_NO_WHATSTHIS
        textLabelx->setText(QApplication::translate("QgsDelimitedTextSourceSelectBase", "<p align=\"left\">X field</p>", Q_NULLPTR));
        textLabely->setText(QApplication::translate("QgsDelimitedTextSourceSelectBase", "<p align=\"left\">Y field</p>", Q_NULLPTR));
        ...
        layeSettingsGroupBox->setTitle(QApplication::translate("QgsDelimitedTextSourceSelectBase", "Layer Settings", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
