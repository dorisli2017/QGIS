...
public:
    ...
    void setupUi(QgsDockWidget *QgsAdvancedDigitizingDockWidgetBase)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/themes/default/cadtools/cad.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mEnableAction->setIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/images/themes/default/cadtools/construction.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mConstructionModeAction->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/images/themes/default/cadtools/parallel.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mParallelAction->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/images/themes/default/cadtools/perpendicular.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mPerpendicularAction->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/images/themes/default/propertyicons/settings.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mSettingsAction->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/images/themes/default/cadtools/lock.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mLockYButton->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/images/themes/default/cadtools/delta.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mLockAngleButton->setIcon(icon5);
        ...
        mLockDistanceButton->setIcon(icon5);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/images/themes/default/locked_repeating.svg"), QSize(), QIcon::Normal, QIcon::Off);
