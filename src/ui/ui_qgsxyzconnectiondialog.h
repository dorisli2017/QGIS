...
public:
    ...
    void setupUi(QDialog *QgsXyzConnectionDialog)
    {
        ...
        QgsXyzConnectionDialog->resize(636, 624);
...
#ifndef QT_NO_TOOLTIP
        mEditUrl->setToolTip(QApplication::translate("QgsXyzConnectionDialog", "URL of the connection, {z}, {y}, and {z} will be replaced with actual values. Use {-y} for inverted y axis.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
