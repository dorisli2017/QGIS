...
public:
    ...
    void setupUi(QDialog *QgsLayoutAttributeSelectionDialogBase)
    {
        ...
        QgsLayoutAttributeSelectionDialogBase->resize(517, 729);
        ...
        mSortColumnComboBox->setObjectName(QStringLiteral("mSortColumnComboBox"));
        ...
        mOrderComboBox->setObjectName(QStringLiteral("mOrderComboBox"));
        ...
        QWidget::setTabOrder(mResetColumnsPushButton, mSortColumnComboBox);
        QWidget::setTabOrder(mSortColumnComboBox, mOrderComboBox);
        QWidget::setTabOrder(mOrderComboBox, mAddSortColumnPushButton);
        QWidget::setTabOrder(mAddSortColumnPushButton, mSortColumnTableView);
