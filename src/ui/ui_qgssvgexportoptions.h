...
public:
    ...
    void setupUi(QDialog *QgsSvgExportOptionsDialog)
    {
        ...
        QgsSvgExportOptionsDialog->resize(489, 464);
    ...
    void retranslateUi(QDialog *QgsSvgExportOptionsDialog)
    {
        ...
        chkMapLayersAsGroup->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Export map layers as SVG groups (may affect label placement)", Q_NULLPTR));
        ...
        mIncludeMetadataCheckbox->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Export RDF metadata", Q_NULLPTR));
