...
public:
    ...
    QgsCollapsibleGroupBox *mDatumTransformGroupBox;
    ...
    QSpinBox *mWMSMaxAtlasFeaturesSpinBox;
    ...
    QSpinBox *mWMTSMinScaleLineEdit;
    ...
    void setupUi(QDialog *QgsProjectPropertiesBase)
    {
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/images/themes/default/relation.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/images/themes/default/propertyicons/action.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem7 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem7->setIcon(icon7);
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/images/themes/default/propertyicons/overlay.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 537, 795));
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/images/themes/default/mActionFileOpen.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mButtonOpenProjectFolder->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/images/themes/default/symbologyAdd.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pbnAddScale->setIcon(icon10);
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/images/themes/default/symbologyRemove.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pbnRemoveScale->setIcon(icon11);
        ...
        pbnExportScales->setIcon(icon12);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 546, 164));
        ...
        mDatumTransformGroupBox = new QgsCollapsibleGroupBox(scrollAreaWidgetContents);
        mDatumTransformGroupBox->setObjectName(QStringLiteral("mDatumTransformGroupBox"));
        gridLayout_2 = new QGridLayout(mDatumTransformGroupBox);
        ...
        gridLayout_2->addWidget(mShowDatumTransformDialogCheckBox, 0, 0, 1, 1);
        ...
        gridLayout_2->addWidget(mDatumTransformTableWidget, 1, 0, 1, 1);


        verticalLayout_7->addWidget(mDatumTransformGroupBox);
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 269, 553));
        ...
        QIcon icon13;
        icon13.addFile(QStringLiteral(":/images/themes/default/symbologyEdit.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pbtnStyleMarker->setIcon(icon13);
        ...
        pbtnStyleColorRamp->setIcon(icon13);
        ...
        QIcon icon14;
        icon14.addFile(QStringLiteral(":/images/themes/default/mActionStyleManager.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pbtnStyleManager->setIcon(icon14);
        ...
        mButtonCopyColors->setIcon(icon15);
        ...
        mButtonAddColor->setIcon(icon10);
        ...
        mButtonPasteColors->setIcon(icon16);
        ...
        mButtonRemoveColor->setIcon(icon11);
        ...
        mButtonImportColors->setIcon(icon9);
        ...
        mButtonExportColors->setIcon(icon12);
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 167, 55));
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 598, 2732));
        ...
        gridLayout_6->addWidget(mWMSOnlineResourceLineEdit, 3, 1, 1, 1);
        ...
        gridLayout_6->addWidget(mWMSOnlineResourceLabel, 3, 0, 1, 1);
        ...
        gridLayout_6->addWidget(mWMSContactMail, 6, 1, 1, 1);
        ...
        gridLayout_6->addWidget(mWMSContactPerson, 4, 1, 1, 1);
        ...
        gridLayout_6->addWidget(mWMSFeesCb, 9, 1, 1, 1);
        ...
        gridLayout_6->addWidget(mWMSAccessConstraintsCb, 10, 1, 1, 1);
        ...
        mAddLayerRestrictionButton->setIcon(icon10);
        ...
        mRemoveLayerRestrictionButton->setIcon(icon11);
        ...
        pbnWMSRemoveSRS->setIcon(icon11);
        ...
        mWMSMaxAtlasFeaturesSpinBox = new QSpinBox(grpWMSCapabilities);
        ...
        mAddWMSPrintLayoutButton->setIcon(icon10);
        ...
        mRemoveWMSPrintLayoutButton->setIcon(icon11);
        ...
        mWMTSMinScaleLineEdit = new QSpinBox(grpWmtsCapabilities);
        ...
        QWidget::setTabOrder(scrollArea, mShowDatumTransformDialogCheckBox);
    ...
    void retranslateUi(QDialog *QgsProjectPropertiesBase)
    {
        ...
        ___qlistwidgetitem3->setText(QApplication::translate("QgsProjectPropertiesBase", "Default Styles", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem3->setToolTip(QApplication::translate("QgsProjectPropertiesBase", "Default styles", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem4 = mOptionsListWidget->item(4);
        ___qlistwidgetitem4->setText(QApplication::translate("QgsProjectPropertiesBase", "Data Sources", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem4->setToolTip(QApplication::translate("QgsProjectPropertiesBase", "Data sources", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem5 = mOptionsListWidget->item(5);
        ___qlistwidgetitem5->setText(QApplication::translate("QgsProjectPropertiesBase", "Relations", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem5->setToolTip(QApplication::translate("QgsProjectPropertiesBase", "Relations", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem6 = mOptionsListWidget->item(6);
        ___qlistwidgetitem6->setText(QApplication::translate("QgsProjectPropertiesBase", "Variables", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem6->setToolTip(QApplication::translate("QgsProjectPropertiesBase", "Variables", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem7 = mOptionsListWidget->item(7);
        ___qlistwidgetitem7->setText(QApplication::translate("QgsProjectPropertiesBase", "Macros", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem7->setToolTip(QApplication::translate("QgsProjectPropertiesBase", "Macros", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem8 = mOptionsListWidget->item(8);
        ___qlistwidgetitem8->setText(QApplication::translate("QgsProjectPropertiesBase", "QGIS Server", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem8->setToolTip(QApplication::translate("QgsProjectPropertiesBase", "WMS/WFS/WCS Server Configuration", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"(for distance and area calculations)", Q_NULLPTR));
        ...
        mCoordinateDisplayGroup->setTitle(QApplication::translate("QgsProjectPropertiesBase", "Coordinate Display", Q_NULLPTR));
        label_26->setText(QApplication::translate("QgsProjectPropertiesBase", "Precision", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mEvaluateDefaultValues->setToolTip(QApplication::translate("QgsProjectPropertiesBase", "When enabled, default values will be evaluated as early as possible. This will fill default values in the add feature form already and not only create them on commit. Only supported for postgres provider.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
