...
public:
    ...
    void setupUi(QWidget *QgsLayoutMapWidgetBase)
    {
        ...
        QgsLayoutMapWidgetBase->resize(384, 749);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -257, 373, 960));
        ...
        mMapRotationLabel_2 = new QLabel(groupBox);
        mMapRotationLabel_2->setObjectName(QStringLiteral("mMapRotationLabel_2"));

        gridLayout_5->addWidget(mMapRotationLabel_2, 3, 0, 1, 1);
        ...
        gridLayout_5->addWidget(mDrawCanvasItemsCheckBox, 4, 0, 1, 2);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/images/themes/default/symbologyAdd.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mAddGridPushButton->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/images/themes/default/symbologyRemove.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mRemoveGridPushButton->setIcon(icon8);
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/images/themes/default/mActionArrowUp.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mGridUpButton->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/images/themes/default/mActionArrowDown.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mGridDownButton->setIcon(icon10);
        ...
        mDrawGridCheckBox = new QCheckBox(mGridGroupBox);
        mDrawGridCheckBox->setObjectName(QStringLiteral("mDrawGridCheckBox"));
        mDrawGridCheckBox->setChecked(true);

        horizontalLayout_13->addWidget(mDrawGridCheckBox);
        ...
        mAddOverviewPushButton->setIcon(icon7);
        ...
        mRemoveOverviewPushButton->setIcon(icon8);
        ...
        mOverviewUpButton->setIcon(icon9);
        ...
        mOverviewDownButton->setIcon(icon10);
        ...
        QWidget::setTabOrder(mGridListWidget, mDrawGridCheckBox);
        QWidget::setTabOrder(mDrawGridCheckBox, mDrawGridCheckBox);
        QWidget::setTabOrder(mDrawGridCheckBox, mGridPropertiesButton);
    ...
    void retranslateUi(QWidget *QgsLayoutMapWidgetBase)
    {
        ...
        mMapRotationLabel_2->setText(QApplication::translate("QgsLayoutMapWidgetBase", "CRS", Q_NULLPTR));
        ...
        label_2->setText(QApplication::translate("QgsLayoutMapWidgetBase", "Scale", Q_NULLPTR));
        ...
        mDrawGridCheckBox->setText(QApplication::translate("QgsLayoutMapWidgetBase", "Draw grid", Q_NULLPTR));
