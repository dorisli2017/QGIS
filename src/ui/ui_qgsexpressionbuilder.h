...
public:
    ...
    void setupUi(QWidget *QgsExpressionBuilderWidgetBase)
    {
        ...
        txtHelpText = new QTextEdit(mHelpAndValuesWidget);
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("QgsExpressionBuilderWidgetBase", "Output preview is generated <br> using the first feature from the layer.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("QgsExpressionBuilderWidgetBase", "Expected Format:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        lblExpected->setToolTip(QApplication::translate("QgsExpressionBuilderWidgetBase", "Output preview is generated <br> using the first feature from the layer.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        lblExpected->setText(QApplication::translate("QgsExpressionBuilderWidgetBase", "string [r,g,b,a] as int 0-255 or #RRGGBBAA as hex or color as color's name", Q_NULLPTR));
