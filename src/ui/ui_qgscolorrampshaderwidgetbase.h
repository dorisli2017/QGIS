...
public:
    ...
    void setupUi(QWidget *QgsColorRampShaderWidgetBase)
    {
        ...
        gridLayout->addWidget(mColormapTreeWidget, 3, 0, 1, 3);
        ...
        gridLayout->addWidget(mClipCheckBox, 6, 0, 1, 3);
        ...
        mNumberOfEntriesSpinBox = new QSpinBox(QgsColorRampShaderWidgetBase);
    ...
    {
        QgsColorRampShaderWidgetBase->setWindowTitle(QApplication::translate("QgsColorRampShaderWidgetBase", "Form", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        mUnitLabel->setText(QApplication::translate("QgsColorRampShaderWidgetBase", "Label unit\n"
"suffix", Q_NULLPTR));
    } // retranslateUi
