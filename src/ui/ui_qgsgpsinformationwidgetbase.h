...
public:
    ...
    void setupUi(QWidget *QgsGpsInformationWidgetBase)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 214, 505));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 241, 696));
        ...
        gridLayout_7->addWidget(mLogFileGroupBox, 6, 0, 1, 1);
...
"2D/3D depends on this information being available", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mTxtQuality->setToolTip(QApplication::translate("QgsGpsInformationWidgetBase", "quality of the position fix: Differential, Non-differential or No position", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        groupBox->setTitle(QApplication::translate("QgsGpsInformationWidgetBase", "Map Centering", Q_NULLPTR));
