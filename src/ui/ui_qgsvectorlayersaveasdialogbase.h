...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerSaveAsDialogBase)
    {
        ...
        QWidget::setTabOrder(mFormatComboBox, mFilename);
        QWidget::setTabOrder(mFilename, leLayername);
        ...
        QWidget::setTabOrder(mSelectedOnly, mSelectAllAttributes);
        QWidget::setTabOrder(mSelectAllAttributes, mDeselectAllAttributes);
        QWidget::setTabOrder(mDeselectAllAttributes, mSymbologyExportComboBox);
        ...
        QWidget::setTabOrder(mIncludeZCheckBox, mAttributeTable);
        QWidget::setTabOrder(mAttributeTable, mReplaceRawFieldValues);
        QWidget::setTabOrder(mReplaceRawFieldValues, mOgrDatasourceOptions);
