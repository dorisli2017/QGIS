...
public:
    ...
    void setupUi(QWidget *QgsLayoutGuideWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 217, 526));
        ...
        verticalLayout_2->addWidget(mPageLabel);
        ...
        verticalLayout_2->addWidget(mSnapToGridGroupCheckBox_2);
        ...
        QWidget::setTabOrder(scrollArea, mSnapToGridGroupCheckBox);
    ...
    void retranslateUi(QWidget *QgsLayoutGuideWidgetBase)
    {
        ...
        mPageLabel->setText(QApplication::translate("QgsLayoutGuideWidgetBase", "Guides for page 1", Q_NULLPTR));
