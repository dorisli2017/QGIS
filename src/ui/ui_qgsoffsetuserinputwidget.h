...
public:
    ...
    QLabel *label_3;
    QSpinBox *mQuadrantSpinBox;
    QLabel *label_4;
    QDoubleSpinBox *mMiterLimitSpinBox;
    ...
    void setupUi(QWidget *QgsOffsetUserInputBase)
    {
        ...
        mOffsetSpinBox = new QDoubleSpinBox(QgsOffsetUserInputBase);
        ...
        mQuadrantSpinBox = new QSpinBox(mAdvancedConfigWidget);
        ...
        mMiterLimitSpinBox = new QDoubleSpinBox(mAdvancedConfigWidget);
    ...
    {
        QgsOffsetUserInputBase->setWindowTitle(QApplication::translate("QgsOffsetUserInputBase", "Form", Q_NULLPTR));
