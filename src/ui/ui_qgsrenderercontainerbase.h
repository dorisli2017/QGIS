...
public:
    ...
    void setupUi(QWidget *QgsRendererWidgetContainerBase)
    {
        ...
        mBackButton = new QPushButton(QgsRendererWidgetContainerBase);
    ...
    {
        QgsRendererWidgetContainerBase->setWindowTitle(QApplication::translate("QgsRendererWidgetContainerBase", "Form", Q_NULLPTR));
