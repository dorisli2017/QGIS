...
public:
    ...
    QListWidget *mDatasetsListWidget;
    ...
    void setupUi(QDialog *QgsMeshCalculatorDialogBase)
    {
        ...
        mDatasetsListWidget = new QListWidget(mRasterBandsGroupBox);
        mDatasetsListWidget->setObjectName(QStringLiteral("mDatasetsListWidget"));
        mDatasetsListWidget->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::DoubleClicked|QAbstractItemView::SelectedClicked);
        mDatasetsListWidget->setSelectionMode(QAbstractItemView::SingleSelection);
        ...
        gridLayout_5 = new QGridLayout(mResultGroupBox);
        ...
        sizePolicy.setHeightForWidth(extendBox->sizePolicy().hasHeightForWidth());
        extendBox->setSizePolicy(sizePolicy);
        ...
        gridLayout_5->addWidget(extendBox, 8, 0, 1, 1);
        ...
        gridLayout_5->addWidget(horizontalWidget, 2, 0, 1, 1);
        ...
        sizePolicy1.setHeightForWidth(cboLayerMask->sizePolicy().hasHeightForWidth());
        cboLayerMask->setSizePolicy(sizePolicy1);
        cboLayerMask->setEditable(false);

        maskBoxLayout->addWidget(cboLayerMask);


        gridLayout_5->addWidget(maskBox, 6, 0, 1, 1);

        verticalSpacer_2 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_5->addItem(verticalSpacer_2, 16, 0, 1, 1);
        ...
        horizontalLayout->addWidget(mOutputDatasetLabel);
        ...
        horizontalLayout->addWidget(mOutputDatasetFileWidget);
        ...
        gridLayout_5->addItem(verticalSpacer, 12, 0, 1, 1);
        ...
        gridLayout_5->addLayout(horizontalLayout_2, 13, 0, 1, 1);
        ...
        gridLayout_5->addLayout(gridLayout_4, 15, 0, 1, 1);
        ...
        splitter_2->raise();
        QWidget::setTabOrder(mDatasetsListWidget, mXMinSpinBox);
