...
#include "../../../../../../../../../external/o2/src/o2requestor.h"
...
void O2Requestor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O2Requestor::finished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O2Requestor::uploadProgress)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject O2Requestor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_O2Requestor.data,
      qt_meta_data_O2Requestor,  qt_static_metacall, nullptr, nullptr}
};
