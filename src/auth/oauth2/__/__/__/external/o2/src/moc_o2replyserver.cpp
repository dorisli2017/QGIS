...
#include "../../../../../../../../../external/o2/src/o2replyserver.h"
...
void O2ReplyServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O2ReplyServer::verificationReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O2ReplyServer::serverClosed)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject O2ReplyServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_O2ReplyServer.data,
      qt_meta_data_O2ReplyServer,  qt_static_metacall, nullptr, nullptr}
};
