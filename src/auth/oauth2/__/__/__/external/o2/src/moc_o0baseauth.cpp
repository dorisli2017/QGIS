...
#include "../../../../../../../../../external/o2/src/o0baseauth.h"
...
void O0BaseAuth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::openBrowser)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::closeBrowser)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::linkingSucceeded)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::linkingFailed)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::linkedChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::clientIdChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::clientSecretChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::localPortChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::tokenChanged)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::tokenSecretChanged)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (O0BaseAuth::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&O0BaseAuth::extraTokensChanged)) {
                *result = 10;
                return;
            }
        }
...
const QMetaObject O0BaseAuth::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_O0BaseAuth.data,
      qt_meta_data_O0BaseAuth,  qt_static_metacall, nullptr, nullptr}
};
