...
QT_MOC_LITERAL(3, 43, 5) // "index"
    ...
    "QgsDataSourceSelectDialog\0onLayerSelected\0"
    "\0index"
};
...
void QgsDataSourceSelectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QgsDataSourceSelectDialog *_t = static_cast<QgsDataSourceSelectDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onLayerSelected((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject QgsDataSourceSelectDialog::staticMetaObject = {
