...
QT_MOC_LITERAL(7, 69, 12), // "setCharacter"
QT_MOC_LITERAL(8, 82, 3) // "chr"

    },
    "QgsCharacterSelectorDialog\0selectCharacter\0"
    "\0bool*\0gotChar\0font\0style\0setCharacter\0"
    "chr"
};
...
static const uint qt_meta_data_QgsCharacterSelectorDialog[] = {
 ...
 // slots: parameters
    QMetaType::Void, 0x80000000 | 3, QMetaType::QFont, QMetaType::QString,    4,    5,    6,
...
void QgsCharacterSelectorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectCharacter((*reinterpret_cast< bool*(*)>(_a[1])),(*reinterpret_cast< const QFont(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3]))); break;
        case 1: _t->setCharacter((*reinterpret_cast< QChar(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject QgsCharacterSelectorDialog::staticMetaObject = {
