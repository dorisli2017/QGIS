...
QT_MOC_LITERAL(1, 18, 8), // "addError"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 18), // "QgsGeometry::Error"
QT_MOC_LITERAL(4, 47, 5), // "error"
QT_MOC_LITERAL(5, 53, 19), // "currentLayerChanged"
QT_MOC_LITERAL(6, 73, 12), // "QgsMapLayer*"
QT_MOC_LITERAL(7, 86, 5), // "layer"
QT_MOC_LITERAL(8, 92, 13) // "stopCapturing"

    },
    "QgsMapToolCapture\0addError\0\0"
    "QgsGeometry::Error\0error\0currentLayerChanged\0"
    "QgsMapLayer*\0layer\0stopCapturing"
};
...
void QgsMapToolCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addError((*reinterpret_cast< const QgsGeometry::Error(*)>(_a[1]))); break;
        case 1: _t->currentLayerChanged((*reinterpret_cast< QgsMapLayer*(*)>(_a[1]))); break;
        case 2: _t->stopCapturing(); break;
        default: ;
        }
    }
}

const QMetaObject QgsMapToolCapture::staticMetaObject = {
